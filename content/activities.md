...
- 연재 '스프링 배치로 전수받는 배치 프로그래밍의 비급' (2008년 7월호 ~ 11월호)
  - 8월호 : 읽기와 쓰기
  - 10월호 : 재시도와 이벤트 처리
  - 연재 원고는 잡지사의 허락을 얻어 한국 스프링 사용자 모임(KSUG) 블로그에 '스프링배치 연재' 16편으로 다시 게재
- 대용량 데이터 배치 처리와 ETL 도구를 다룬 기고 (2009년)
- 스프링루(Spring Roo)를 이용한 스프링 3.0 프로그래밍 (2010년 9월호) : 커버스토리 '엔터프라이즈로의 확장, 스프링 프레임워크 3.0'의 3부

## 발표

외부 발표는 모두 회사에서 안내된 절차에 따라 발표 내용에 대한 허가를 받고 진행했습니다.
